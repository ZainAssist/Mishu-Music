...
from Zainu.misc import SUDOERS, SPECIAL_ID
from Zainu.utils.database import add_sudo, remove_sudo
from Zainu.utils.decorators.language import language
from Zainu.utils.extraction import extract_user
...
async def sudoers_list(client, message: Message):
    ...
    #await message.reply_photo(photo="https://graph.org/file/454bd282e3ea1f7d4865e-ec7b6a3993047e96cd.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
    await message.reply_video(video="https://graph.org/file/454bd282e3ea1f7d4865e-ec7b6a3993047e96cd.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
