...
#from Zainu.utils.errors import capture_err
import httpx 
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup
...
┌┬─────────────────⦿
│├─────────────────╮
│├ 𝗡ᴀᴍᴇ - [ȤàƖƝ](https://t.me/Uff_Zainu)
│├ 𝗙ᴜʟʟ 𝗜ɴғᴏ - [𝐂ʟɪᴄᴋ 𝐇ᴇʀᴇ](https://t.me/About_Zain/3)
│├─────────────────╯
├┼─────────────────⦿
│├─────────────────╮
│├ Dᴇᴠᴇʟᴏᴘᴇʀ│ [ЄƬЄƦƝƖƬƳ](https://t.me/The_Eternity_Soul)
│├─────────────────╯
└┴─────────────────⦿
**
"""
...
InlineKeyboardButton("\x4F\x46\x46\x49\x43\x49\x41\x4C\x20\x42\x4F\x54", url=f"\x68\x74\x74\x70\x73\x3A\x2F\x2F\x74\x2E\x6D\x65\x2F\x41\x6C\x6F\x6E\x65\x58\x4D\x75\x73\x69\x63\x42\x6F\x74"),
    ...
    await msg.reply_photo(
        photo="https://graph.org/file/4e9c4641e71f29f34e51d-beea1d40c2961c10cc.jpg",
        caption=start_txt,
