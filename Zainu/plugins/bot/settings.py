...
from Zainu.utils.decorators.admins import ActualAdminCB
from Zainu.utils.decorators.language import language, languageCB
from Zainu.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from Zainu.utils.inline.start import private_panel
...
async def gib_repo_callback(_, callback_query):
    await callback_query.edit_message_media(
        media=InputMediaVideo(
            "https://graph.org/file/4e9c4641e71f29f34e51d-beea1d40c2961c10cc.jpg", 
            has_spoiler=True, 
